...
public:
	/**
	 * CONSTRUCTOR FOR BitArray CLASS
	 */
	...
	/**
	 * Function to free all memory allocated by the BitArray object.
	 */
	~BitArray();
};
...
public:
	...
	BitArray *bitArray; // POINTER TO BitArray OBJECT
	 ...
	 */
	Node(int start, int end, BitArray *bitArray);

	/**
	 * Destructor for Node class
	 * This function must free all the memory allocated for the node.
	 */
	~Node();
};
...
public:
	 ...
	 */
	void addNode(int start, int end, BitArray *bitArray);
	 ...
	 */
	bool isSeenBefore(int number);

	/**
	 * Destructor for LinkedList class
	 * This function must free all the memory allocated for the linked list.
	 */
	~LinkedList();
};
